...
let tail = ((_, b, c)) => (b, c);
let mapFirst = ((a, b, c), ~f as [@ns.namedArgLoc] f) => (f(a), b, c);
let mapSecond = ((a, b, c), ~f as [@ns.namedArgLoc] f) => (a, f(b), c);
let mapThird = ((a, b, c), ~f as [@ns.namedArgLoc] f) => (a, b, f(c));
let mapEach =
    (
      (a, b, c),
      ~f as [@ns.namedArgLoc] f,
      ~g as [@ns.namedArgLoc] g,
      ~h as [@ns.namedArgLoc] h,
    ) => (
  f(a),
  g(b),
  h(c),
);
let mapAll = ((a1, a2, a3), ~f as [@ns.namedArgLoc] f) => (
  f(a1),
  f(a2),
  f(a3),
);
...
let compare =
    (
      ...
      ~h as [@ns.namedArgLoc] compareThird,
    ) =>
