...
describe("fromString", () => {
  [@ns.braces]
  {
    test("converts string to Some(true)", () =>
      expect(fromString("true"))->(toEqual(Some(true)))
    );
    test("converts string to Some(false)", () =>
      expect(fromString("false"))->(toEqual(Some(false)))
    );
    test("capital True returns None", () =>
      expect(fromString("True"))->(toEqual(None))
    );
    test("non-string returns None", () =>
      expect(fromString("1"))->(toEqual(None))
    );
  }
});
describe("xor", () => {
...
describe("not", () => {
  [@ns.braces]
  {
    test("Returns negation of true, returns false", () =>
      expect(!true)->(toEqual(false))
    );
    test("Returns negation of false, returns true", () =>
...
describe("toInt", () => {
  [@ns.braces]
  {
    test("Returns 1 for arg true", () =>
      expect(toInt(true))->(toEqual(1))
    );
    test("Returns 0 for arg false", () =>
...
describe("equal", () => {
  [@ns.braces]
  {
    ...
    test("Returns true equal for args false false", () =>
      expect(equal(false, false))->(toEqual(true))
    );
